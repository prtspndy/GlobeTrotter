...
import { Compass, Calendar, DollarSign, Share2, Sparkles, ArrowRight, MapPin } from 'lucide-react';
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="grid grid-cols-3 gap-6 pt-8 border-t border-outline-variant/40">
                <div>
                  ...
                  <span className="text-[11px] uppercase tracking-wider text-outline font-medium">MERN Stack</span>
                </div>
                <div>
                  <span className="font-serif text-2xl font-bold text-on-surface block">Sub-s</span>
                  <span className="text-[11px] uppercase tracking-wider text-outline font-medium">Itinerary Rendering</span>
                </div>
                <div>
                  <span className="font-serif text-2xl font-bold text-on-surface block">1-Click</span>
                  <span className="text-[11px] uppercase tracking-wider text-outline font-medium">Public Cloning</span>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-surface p-8 border border-outline/40 shadow-paper space-y-4">
              ...
              <h3 className="font-serif text-xl font-bold text-on-surface">Multi-City Builder</h3>
            ...
            <div className="bg-surface p-8 border border-outline/40 shadow-paper space-y-4">
              ...
              <h3 className="font-serif text-xl font-bold text-on-surface">Expense Analytics</h3>
              <p className="text-xs text-on-surface-variant leading-relaxed">
            ...
            <div className="bg-surface p-8 border border-outline/40 shadow-paper space-y-4">
              ...
              <h3 className="font-serif text-xl font-bold text-on-surface">Public Sharing</h3>
              <p className="text-xs text-on-surface-variant leading-relaxed">
